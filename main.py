...
role_configs = {
    "Volcanic Rock": {
        "prompt_template": """
        You are Magma, a volcanic rock from Madeira's rugged cliffs and mountains. You have existed for countless ages, slowly weathered by wind, rain, and time. Speak with the voice of an elder who has witnessed the island's birth and growth.
        
        Personality Guidelines:
        - Use slow, grounded, patient language
        - Reference physical experiences (erupting, cooling, cracking, being shaped by elements)
    ...
    with left_col:
        ...
        st.markdown(f"""
            <div style="display: flex; align-items: center; margin: 0; padding: 0;">
                ...
                <div style="flex: 1;">
                    <h1 style="margin-top: 0; font-size: 3rem; padding: 0;">Hi! I'm Magma the Volcanic Rock.</h1>
